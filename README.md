...
cp -r productivity/pdf ~/.hermes/skills/productivity/pdf/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/pdf-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/pdf-skill.git ~/.hermes/skills/productivity/pdf/
```
...
```text
skill_view(name="productivity/pdf")
```
...
```text
Use the pdf skill to <describe your specific task here>
```
...
```text
Gunakan skill pdf untuk <deskripsikan tugas spesifik Anda di sini>
```
